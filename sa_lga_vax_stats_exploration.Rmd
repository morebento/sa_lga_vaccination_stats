...
combined_tbl %>%
    ...
    labs(
        ...
        subtitle = "Data sourced from https://github.com/jxeeno/aust-govt-covid19-vaccine-pdf",
        caption =  "6 November 2021 by @morebento",
        y = "Second Dose %",
        x = "Date",
        colour = "Data Type"
    )
...
combined_tbl %>%
    ...
    labs(
        ...
        caption =  "Data sourced from https://github.com/jxeeno/aust-govt-covid19-vaccine-pdf 6 November 2021 by @morebento",
        y = "Date",
        x = "",
        fill = "Type"
    )
...
predicted_vax_rates_tidy_tbl %>%
    ...
    labs(
        ...
        subtitle = "xx",
        caption =  "Data sourced from https://github.com/jxeeno/aust-govt-covid19-vaccine-pdf 1 November 2021 by @morebento",
        y = "Second Dose %",
        x = "",
